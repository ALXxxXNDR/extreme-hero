...
const SKILLS: Array[Dictionary] = [
	...
	{"id":"targeting","name":"번개 창","symbol":"+","kind":"projectile","element":"thunder","form":"pierce","silhouette":"homing","impact":"pin","desc":"알아서 쫓아가 두 번 꽂는다","combo":"기름 묻은 적은 크게 터진다","damage":0.92,"duration":0.84,"action_ratio":0.84,"reload":0.26,"range":520.0,"arc":0.2,"hits":2,"projectiles":1,"pierce":1,"homing":1.8,"color":"f4d35e","debt_desc":"마왕의 검기가 나를 쫓아옵니다."},
	...
	{"id":"execution","name":"독의 처형","symbol":"X","kind":"melee","element":"poison","form":"slash","silhouette":"heavy_slash","impact":"pin","desc":"한 방이 아주 세다","combo":"독이 깊게 남고 쿨타임 길다","damage":4.20,"duration":1.62,"action_ratio":0.55,"reload":0.77,"range":158.0,"arc":1.55,"hits":1,"heavy":true,"color":"83c65c","debt_desc":"마왕의 한 방이 아주 세집니다."},
